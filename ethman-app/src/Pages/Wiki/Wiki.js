        ...
        <div className="content">
            ...
            <div className="content__collapsible">
                <Collapsible trigger="What is ETH-MEN all about?">
                    <p>ETH-MEN are a variety of collectibles. However our primary goal is to deliver digital action
                        figures
                        and comics on the ethereum blockchain, running 100% on IPFS! These take you back to the
                        nostalgic
                ...
                <Collapsible trigger="Is there a setbonus?">
                    <p>Most figures are part of a set. This means that if you collect all figures of that set before a
                        certain time, you will get the free setbonus as a reward. If an account completes multiple sets
                        of
                ...
                <Collapsible trigger="How do I get the 3D figure?">
                    <p>You can unpack the figure by loging in on our website with metamask. Unpacking the figure
                        initiates a
                        'burning' of the original front-card package, figure, and accessories. Followed by a minting of
                        a
                        new replacement NFT. A 3D model (GLB-file) of the unpacked ETH-MEN figure along with it’s
                        card-back
                        cutout.</p>
                </Collapsible>
                <Collapsible trigger="What are ETH-MEN Avatars?">
                    <p>What better way to showcase your ETH-MEN allegiance than avatars! Ultra-rare, stylishly
                        illustrated
                        character icons. Ideal for use on Twitter, Discord, OpenSea, Rarible, all over the universe! And
                        most important: every avatar is completely unique, so you will be the only one owing that
                        specific
                ...
                <Collapsible trigger="Whats the difference between the different comics?">
                    <p>Our comics come in 4 different editions. The sketch edition is the rarest edition of all, with a
                        total of only 65 copies in existence. Amazing to see how the artist's raw sketches set the stage
                        for
                        the extraordinary storyline. A total of 90 copies are released in Black and White, showcasing
                        all
                        ...
                        standard edition, these are in fact rare, valuable and desirable. Perhaps best to keep these
                        sealed
                        and unpack/read a Standard Edition copy!


                        A total of 250 copies are released for everyday reading. The packaging and cover show a bit of
                        wear
                        and tear.</p>
                </Collapsible>
                <Collapsible trigger="What is the migration function on the website?">
                    <p>Initially each ETH-MEN figure was purchased as a ‘front-card’ which consisted of the character
                        figure
                        and accessories. The informational ‘card-back’ would later be sent to the owner of the
                        front-card.
